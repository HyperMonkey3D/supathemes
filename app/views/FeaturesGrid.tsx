  ...
  return (
    <section className="w-full xl:w-[1200px] min-h-[650px] h-fit bg-brand-dark-gray py-11">
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 grid-rows-4 sm:grid-rows-2 gap-4  md:gap-10 w-[85%] h-full bg-brand-dark-gray  mx-auto">
        <div className="bg-slate-3 w-full h-full p-8 flex flex-col justify-evenly  lg:col-span-2 bg-brand-darker-gray border border-brand-stroke-dark-gray rounded-xl  ">
        ...
        <div className="bg-slate-3 w-full h-full p-8 flex flex-col justify-evenly bg-brand-darker-gray border  border-brand-stroke-dark-gray rounded-xl relative ">
          <Spheres />
