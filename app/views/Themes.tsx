...
const Themes = () => {
  return (
    <section className="w-full xl:w-[1200px]  h-fit  bg-slate-600">
      <div className="bg-gradient-to-tr from-brand-purple-dark from-10% via-brand-purple-mid  to-brand-purple-light to-60% w-full h-[550px]  sm:h-[650px]  lg:h-[750px]">
        <div className="grid grid-cols-1 lg:grid-cols-2 grid-rows-2 lg:grid-rows-1 h-full relative">
          <div className=" w-full lg:w-[400px] h-fit lg:h-full flex flex-col justify-center items-start pl-8">
            ...
            <div className=" w-[145px]  md:w-[163px] lg:w-[183px] h-[50px] md:h-[50px] lg:h-[56px] bg-brand-pink border border-brand-pink rounded-xl flex justify-center items-center">
